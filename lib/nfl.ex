defmodule StattleshipEx.NFL do
  @moduledoc """
  Stattleship NFL Feeds
  ...
  {:ok, %{body: games}} = StattleshipEx.NFL.games(on: "today")
  {:ok, %{body: games}} = StattleshipEx.NFL.games(fetch_all: true)
  {:ok, %{body: games}} = StattleshipEx.NFL.games(status: 'in-progress,postgame-reviewing')
  {:ok, %{body: games}} = StattleshipEx.NFL.games(team_id: "nfl-gs")
  {:ok, %{body: games}} = StattleshipEx.NFL.games(team_id: "nfl-gs")
  ...
  """
  def games(query \\ []) do
    StattleshipEx.get("/football/nfl/games", query: query)
  end
  ...
  ## Examples:
      ...
      {:ok, %{body: games}} = StattleshipEx.NFL.play_by_play(game_id: game_id, week: 2)
      {:ok, %{body: games}} = StattleshipEx.NFL.play_by_play(week: 16, fetch_all: true)
  ...
  * `status` Game status of in_progress upcoming or ended
  ...
  def game_logs(query \\ []) do
    StattleshipEx.get("/football/nfl/game_logs", query: query)
  end
  ...
  ## Examples:
      ...
      slug = "nfl-2018-2019-ne-la-2019-02-3-1830"
      {:ok, %{body: games}} = StattleshipEx.NFL.play_by_play(slug, quarter: 2)
      {:ok, %{body: games}} = StattleshipEx.NFL.play_by_play(slug, quarter: 4, fetch_all: true)

  ## Query params:

  * `per_page` 20 Items per page with maximum of 40.
  * `page`  Page of results
  * id  Required game slug as a resource, ie play_by_play/nfl-2016-2017-pho-lac-2016-10-31-1930
  * `quarter`  Number
  * `team_id`  Team slug such as nfl-bos for the Celtics.
  ...
  * `per_page`  You can request up to 100 per page
  ...
  def play_by_play(game_slug, query \\ []) do
    StattleshipEx.get("/football/nfl/play_by_play/#{game_slug}", query: query)
  end
  ...
  * `page` Page of results
  ...
  def scoring_plays(query \\ []) do
    StattleshipEx.get("/football/nfl/scoring_plays", query: query)
  end
  ...
  """
  def teams(query \\ []) do
    StattleshipEx.get("/football/nfl/teams", query: query)
  end
  ...
  """
  def feats(query \\ []) do
    StattleshipEx.get("/football/nfl/feats", query: query)
  end
  ...
  def injuries(query \\ []) do
    StattleshipEx.get("/football/nfl/injuries", query: query)
  end
  ...
  def officials(query \\ []) do
    StattleshipEx.get("/football/nfl/officials", query: query)
  end
  ...
  def players(query \\ []) do
    StattleshipEx.get("/football/nfl/players", query: query)
  end
  ...
  def player_season_stats(query \\ []) do
    StattleshipEx.get("/football/nfl/player_season_stats", query: query)
  end
  ...
  def rankings(query \\ []) do
    StattleshipEx.get("/football/nfl/rankings", query: query)
  end
  ...
  def rosters(query \\ []) do
    StattleshipEx.get("/football/nfl/rosters", query: query)
  end
  ...
  def scoreboards(query \\ []) do
    StattleshipEx.get("/football/nfl/scoreboards", query: query)
  end
  ...
  def seasons(query \\ []) do
    StattleshipEx.get("/football/nfl/seasons", query: query)
  end
  ...
  def team_game_logs(query \\ []) do
    StattleshipEx.get("/football/nfl/team_game_logs", query: query)
  end
  ...
  def team_outcome_streaks(query \\ []) do
    StattleshipEx.get("/football/nfl/team_outcome_streaks", query: query)
  end
end
